...
Invoke with ` + "`/agents:start <name>`" + `. List with ` + "`/agents:list`" + `; board ` + "`/agents:status`" + `; next move ` + "`/agents:next`" + `; health check ` + "`/agents:doctor`" + `; scheduled tasks ` + "`/agents:schedule`" + `; guide ` + "`/agents:help`" + `.
` + ClaudeEnd + "\n"
...
// /agents:list, /agents:status, /agents:next, /agents:doctor, /agents:schedule, /agents:new) — the same commands
